...
const IOS_FIXTURES = path.join(REPO_ROOT, 'apps/starter-ios/StarterAppTests/Fixtures');
const ANDROID_FIXTURES = path.join(REPO_ROOT, 'apps/starter-android/app/src/test/resources/fixtures');
